...
UsersRoles=db.Table("UsersRoles",
...
class Users(db.Model,UserMixin):
  ...
  purchase= db.relationship('PurchasedBook',cascade="all,delete",back_populates="user")
  payment= db.relationship("PaymentDetails",uselist=False,cascade="all,delete",back_populates="user")
...
class Books(db.Model):
  ...
  purchase = db.relationship('PurchasedBook',cascade="all,delete",back_populates="book")
